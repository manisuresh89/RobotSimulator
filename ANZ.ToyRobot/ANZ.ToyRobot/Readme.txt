...
- A robot that is not on the table can choose the ignore the MOVE, LEFT, RIGHT and
 ...
 --- Steps to Run
  ...
  1) Navigate to ANZ.ToyRobot\bin\Release
  2) Run the app by running application ANZ.ToyRobot.exe
  3) OPEN the console and run the below commands to operate the Robot
